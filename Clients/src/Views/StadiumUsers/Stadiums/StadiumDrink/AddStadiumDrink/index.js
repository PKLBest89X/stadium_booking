...
const AddStadiumDrink = () => {
  const classes = useStyles();
  const imageDrinkRef = useRef(null);
  const [drinktState, setDrinkState] = useState({
    post_title: "",
    post_details: "",
  ...
  return (
    <ChildPageLayout title="Add Drink">
                ...
                <Box>
                  <Card elevation={10}>
                    ...
                    <textarea
                      ...
                      name="post_details"
                      value={drinktState.stadium_post}
                      type="text"
