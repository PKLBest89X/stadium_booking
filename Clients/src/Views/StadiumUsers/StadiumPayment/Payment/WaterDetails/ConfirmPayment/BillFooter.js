...
const BillFooter = React.memo(({ totalStadiumPrice, totalWaterPrice, total, employee }) => {
    const { getMoney, thonMoney } = useShallowEqualSelector((state) => state.paymentDetails);
