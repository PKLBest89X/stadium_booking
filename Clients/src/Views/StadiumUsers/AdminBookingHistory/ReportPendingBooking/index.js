...
import { onShowReportBooking, onLoadAdminPending } from "../../../../Slices/Features/StadiumUsers/Reports/reportBookingSlice";
...
const ReportPendingBooking = React.memo(() => {
  ...
  useEffect(() => {
    const getReportBooking = async () => {
      ...
      dispatch(onLoadAdminPending("pending"));
    };
    getReportBooking();
  }, [dispatch, stadiumId_Admin]);
  ...
  return (
    <ReportContainerLayout>
      ...
      <Box padding="1rem">
        ...
        {adminPendingSuccess === false && <NonBookingHistory />}
      </Box>
    </ReportContainerLayout>
  );
});

export default ReportPendingBooking;
