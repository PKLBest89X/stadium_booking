...
import { onLoadAdminBookingPaid } from "../../../../Slices/Features/StadiumUsers/Reports/reportBookingSlice";
...
const ReportBookingPaid = React.memo(() => {
  ...
  useEffect(() => {
    const getReportBooking = async () => {
      ...
      dispatch(onLoadAdminBookingPaid("ເຕະແລ້ວ"));
    };
    getReportBooking();
  }, [dispatch, stadiumId_Admin]);
  ...
  return (
    <ReportContainerLayout>
      ...
      <Box padding="1rem">
        ...
        {reportPaidSuccess === false && <NonBookingHistory />}
      </Box>
    </ReportContainerLayout>
  );
});

export default ReportBookingPaid;
