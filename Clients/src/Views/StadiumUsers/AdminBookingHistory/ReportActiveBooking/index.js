...
const ReportActiveBooking = React.memo(() => {
  ...
  useEffect(() => {
    const getReportBooking = async () => {
      ...
      dispatch(onLoadAdminActive("ຍັງບໍ່ເຕະ"));
    };
    getReportBooking();
  }, [dispatch, stadiumId_Admin]);
  ...
  return (
    <ReportContainerLayout>
      ...
      <Box padding="1rem">
        ...
        {adminActiveSuccess === false && <NonBookingHistory />}
      </Box>
    </ReportContainerLayout>
  );
});

export default ReportActiveBooking;
