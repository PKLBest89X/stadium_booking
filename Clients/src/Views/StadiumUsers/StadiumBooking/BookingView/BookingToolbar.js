...
import { onDeleteSelectedDataNonAccount } from "../../../../Slices/Features/StadiumUsers/BookingForNoAccount/bookingDetailsNonAccountSlice";
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton
            aria-label="delete"
            onClick={() => dispatch(onDeleteSelectedDataNonAccount(dataForDelete))}
          >
            <Cancel />
          </IconButton>
        </Tooltip>
