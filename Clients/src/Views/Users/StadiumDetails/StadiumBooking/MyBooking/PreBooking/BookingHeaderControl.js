...
const BookingHeaderControl = (props) => {
  const {
    classes,
    onSelectAllClick,
    order,
  ...
  const headCells = [
    ...
    { id: "kickoff_date", numeric: true, disablePadding: false, label: "ມື້ເຕະ" },
  ];
...
BookingHeaderControl.propTypes = {
...
export default BookingHeaderControl;
